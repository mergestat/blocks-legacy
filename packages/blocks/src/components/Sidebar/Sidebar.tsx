...
const logoMark = require('../../../public/logo-mark-inverse.svg');
...
> = ({
  ...
  className }) => {
    ...
    const toggleCollapsedSidebar = useCallback(() => setCollapsed(state => !state), [
      setCollapsed
    ]);
...
> = ({
  ...
  return (
    <div className={cx("t-sidebar-logo", { [className]: !!className })}>
